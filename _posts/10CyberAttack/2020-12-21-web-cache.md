---
title: Meow's CyberAttack -  - Web cache poison
...
- [Meow's CyberAttack - Web cache poison](#meows-cyberattack---web-cache-poison)
  - [背景知识](#背景知识)
...
# Meow's CyberAttack - Web cache poison
...
- http头的内容也与直接访问 `https://www.example.com/home.php` 相同，caching header、content-type（此处为text/html）也相同。
