...
runner@0f6e1319a2e4:~/SparklingAnguishedPaintprogram/jpm_module_1$ cd jpm_module_1bash: cd: jpm_module_1: No such file or directory

runner@0f6e1319a2e4:~/SparklingAnguishedPaintprogram/jpm_module_1$ git init
Reinitialized existing Git repository in /home/runner/SparklingAnguishedPaintprogram/jpm_module_1/.git/
runner@0f6e1319a2e4:~/SparklingAnguishedPaintprogram/jpm_module_1$ git add -A
runner@0f6e1319a2e4:~/SparklingAnguishedPaintprogram/jpm_module_1$ git config user.email "Lgraceye@hotmail.com"
runner@0f6e1319a2e4:~/SparklingAnguishedPaintprogram/jpm_module_1$ git config user.name "Grace JyL"
runner@0f6e1319a2e4:~/SparklingAnguishedPaintprogram/jpm_module_1$ git commit -m 'INIT'
...
runner@0f6e1319a2e4:~/SparklingAnguishedPaintprogram/jpm_module_1$ exit
exit
0
...
- In unit testing, we always follow the pattern, Build-Act-Assert:
  - Build: build a simulated test scenario
    - e.g.
    - instantiating the dummy data we will pass in the methods we’ll test,
    - importing the class whose methods we want to test, etc.
   - Act: make some operations and call the method want to test for
   - Assert: check if the output of the method we’re testing matches the expectation we have (e.g. dummy / static data of the outcome)
