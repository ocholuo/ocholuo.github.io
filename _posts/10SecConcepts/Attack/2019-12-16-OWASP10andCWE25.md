...
| A8: Insecure Deserialization                    | <br> CWE-502: Deserialization of Untrusted Data                                                                                                                                                                                                                                                                                                            |
...
- `Insecure deserialization` 反序列化: the application rebuilds objects from attacker-controlled serialized data without first verifying the type or contents of that data.
- Native deserializers instantiate whatever classes the byte stream names and run lifecycle callbacks (`readObject`, `__wakeup`, `__destruct`, `__reduce__`) during parsing, so the payload executes before any application-level check.
- Mapped to `CWE-502: Deserialization of Untrusted Data`.
- OWASP `A8:2017 Insecure Deserialization` was merged into `A08:2021 Software and Data Integrity Failures`.
...
- Primary defense:
  - `do not deserialize untrusted data`
    - prefer data-only formats such as `JSON` or `Protobuf` with an explicit schema, and map fields into known types by hand.
  - `allowlist filtering`
    - restrict which classes the deserializer may instantiate (Java `ObjectInputFilter` / `jdk.serialFilter`); denylists are bypassed by each new gadget library.
  - `integrity checks`
    - HMAC-sign any serialized blob that must cross a trust boundary and verify the signature before parsing.

> See the dedicated insecure deserialization note at `_posts/10CyberAttack/0ApplicationServerAttacks/2026-08-11-CyberAttack-Insecure-Deserialization.md` for gadget chains, per-language sinks, and detection.
...
Observed Examples:
- [CVE-2009-2550](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-2550): Classic- stack-based buffer overflow in media player using a long entry in a playlis: - [CVE-2009-2403](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-2403): Heap-based buffer overflow in media- player using a long entry in a playlis: - [CVE-2009-0689](https://cve.mitre.org/cgi-bin/cvename.cgi- name=CVE-2009-0689): large precision value in a format string triggers overflo: - [CVE-2009-0690](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-0690): negative offset value leads to- out-of-bounds rea: - [CVE-2009-1532](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-1532): malformed inputs cause accesses of uninitialized or previously-deleted objects, leading to memory- corruptio: - [CVE-2009-1528](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-1528): chain:- lack of synchronization leads to memory corruptio: - [CVE-2009-0558](https://cve.mitre.org/cgi-bin- cvename.cgi?name=CVE-2009-0558): attacker-controlled array index leads to code executio: - [CVE-2009-0269](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-0269): chain: -1 value from- a function call was intended to indicate an error, but is used as an array index instead: - [CVE-2009-0566](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-0566): chain: incorrect- calculations lead to incorrect pointer dereference and memory corruptio: - [CVE-2009-1350](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-1350): product accepts crafted messages that lead- to a dereference of an arbitrary pointe: - [CVE-2009-0191](https://cve.mitre.org/cgi-bin/cvename- cgi?name=CVE-2009-0191): chain: malformed input causes dereference of uninitialized memory: - [CVE-2008-4113](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-4113): OS kernel trusts- userland-supplied length value, allowing reading of sensitive information: - [CVE-2005-1513](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2005-1513): Chain: integer overflow in securely-coded mail program leads to buffer overflow. In 2005, this was regarded as unrealistic to exploit, but in 2020, it was rediscovered to be easier to exploit due to evolutions of the technology.
- [CVE-2003-0542](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2003-0542): buffer overflow- involving a regular expression with a large number of capture: - [CVE-2017-1000121](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-1000121): chain: unchecked message size metadata allows integer overflow ([CWE-190]) leading to buffer overflow ([CWE-119]).
...
Description
- [CVE-2014-8958](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-8958): Admin GUI allows XSS through cookie.
- [CVE-2017-9764](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-9764): Web stats program allows XSS through crafted HTTP header.
- [CVE-2014-5198](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-5198): Web log analysis product allows XSS through crafted HTTP Referer header.
- [CVE-2008-5080](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-5080): Chain: protection mechanism failure allows XSS
- [CVE-2006-4308](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2006-4308): Chain: incomplete denylist ([CWE-184]) only checks "javascript:" tag, allowing XSS ([CWE-79]) using other tags
- [CVE-2007-5727](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2007-5727): Chain: incomplete denylist ([CWE-184]) only removes SCRIPT tags, enabling XSS ([CWE-79])
- [CVE-2008-5770](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-5770): Reflected XSS using the PATH_INFO in a URL
- [CVE-2008-4730](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-4730): Reflected XSS not properly handled when generating an error message
- [CVE-2008-5734](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-5734): Reflected XSS sent through email message.
- [CVE-2008-0971](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-0971): Stored XSS in a security product.
- [CVE-2008-5249](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-5249): Stored XSS using a wiki page.
- [CVE-2006-3568](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2006-3568): Stored XSS in a guestbook application.
- [CVE-2006-3211](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2006-3211): Stored XSS in a guestbook application using a javascript: URI in a bbcode img tag.
- [CVE-2006-3295](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2006-3295): Chain: library file is not protected against a direct request ([CWE-425]), leading to reflected XSS ([CWE-79]).
...
- Native serialization formats carry type information, so the byte stream decides which classes are instantiated and how they are wired together.
- An attacker who controls the stream therefore controls `the type and the object graph` that the deserializer builds, not just the field values.
- The deserializer runs lifecycle callbacks while rebuilding the graph, so attacker-chosen code executes before the application ever inspects the result.
- A cast or type check after the call is not a control, because the damage is already done by then.


> Alternate Terms: Marshaling, Unmarshaling, Pickling, Unpickling, PHP Object Injection, Gadget Chain


Modes Of Introduction
- The different Modes of Introduction provide information about how and when this weakness may be introduced. The Phase identifies a point in the life cycle at which introduction may occur, while the Note provides a typical scenario related to introduction during the given phase.
- Architecture and Design
  - A protocol or storage format is chosen that transports live objects rather than plain data, for example Java or .NET native serialization on a network-facing endpoint, or a signed-object session cookie.
- Implementation
  - A deserializer is called on input that arrived from a client, message queue, cache, or file, with no class filter and no integrity check in place.
...
- Integrity
  - `Technical Impact: _Execute Unauthorized Code or Commands_`
  - The most common outcome is `remote code execution`, reached by chaining together methods that the deserializer invokes automatically (a gadget chain).
  - The gadgets usually live in a library on the classpath rather than in first-party code, so the vulnerable application may contain no obviously dangerous logic of its own.

- Availability
  - `Technical Impact: _DoS: Crash, Exit, or Restart; DoS: Resource Consumption (CPU); DoS: Resource Consumption (Memory)_`
  - A crafted graph can be made deeply nested or self-referential, so parsing alone exhausts CPU or memory before any payload runs.
  - Deserializing a hash-collision-heavy or recursively equal set of objects is a cheap denial of service even when no code-execution gadget exists.

- Access Control
  - `Technical Impact: _Bypass Protection Mechanism; Gain Privileges or Assume Identity_`
  - When session or token state is stored as a serialized object, an attacker who can forge that object can perform `authentication bypass` and `privilege escalation` by flipping fields such as a role or user identifier.
  - Because the serialized blob is usually accepted again without freshness checking, a captured blob can be resent later as a `replay attack`.
...
```java
// Example 1
// A service reads a serialized object graph straight off the network.
...
// readObject() rebuilds every class named in the byte stream BEFORE the cast to Command is evaluated,
// so the cast is not a security control.
// Any class on the classpath that performs work inside readObject(), readResolve(), or finalize()
// can be recruited into a gadget chain; the commons-collections InvokerTransformer chain is the classic case.
// The stream is recognizable from its magic bytes AC ED 00 05, or rO0 once base64-encoded.
```


```php
// Example 2
// An application restores state from a cookie.
// Example Language: PHP

$state = unserialize($_COOKIE['state']);

// unserialize() instantiates whatever class the attacker names in the O:<len>:"<Class>" header
// and populates its properties with attacker-chosen values.
// Any magic method the object owns then fires without further checks:
// __wakeup() during unserialize(), and __destruct() when the request tears down.

class TempFile {
	public $path;
	function __destruct() { unlink($this->path); }
}

// A cookie value of
// O:8:"TempFile":1:{s:4:"path";s:23:"/var/www/html/.htaccess";}
// deletes an arbitrary file. A POP chain extends the same primitive to code execution.
```


```python
# Example 3
# A worker unpickles a task payload taken from a queue.
# Example Language: Python

import pickle
task = pickle.loads(message.body)

# pickle is a small virtual machine, not a data format.
# Its REDUCE opcode calls any callable named in the stream, which makes __reduce__ an execution primitive.
...
# pickle.dumps(Exploit()) yields a payload that runs the id command the moment it is loaded.
# The same exposure applies to every pickle-backed API: shelve, joblib, torch.load, pandas.read_pickle.
# yaml.load() without SafeLoader and Ruby Marshal.load() behave the same way.
```


Observed Examples
- [CVE-2015-4852](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2015-4852): Oracle WebLogic accepts a serialized Java object on the T3 protocol; a commons-collections gadget chain turns it into unauthenticated remote code execution.
- [CVE-2017-9805](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-9805): Apache Struts2 REST plugin deserializes XML with XStream and no type restriction, giving unauthenticated remote code execution.
- [CVE-2020-9484](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-9484): Apache Tomcat PersistentManager with a FileStore deserializes an attacker-planted session file, chaining file upload into code execution.
- [CVE-2017-7525](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-7525): jackson-databind polymorphic typing instantiates attacker-named classes from JSON, showing that the weakness is not limited to binary formats.
- [CVE-2019-12384](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-12384): jackson-databind denylist bypass using a newly found gadget, demonstrating that denylists do not hold.
- [CVE-2016-7124](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2016-7124): PHP skips `__wakeup()` when the serialized object declares an incorrect property count, bypassing the guard the developer relied on.


Potential Mitigations

- Phase: Architecture and Design
  - `Do not deserialize data that crosses a trust boundary.`
  - This is the only mitigation that removes the weakness rather than narrowing it; everything below assumes the design cannot be changed.

- Phase: Architecture and Design
  - Strategy: Parameterization
  - Prefer data-only interchange formats such as `JSON`, `Protobuf`, or `CBOR` with an explicit schema, and map the parsed fields into known types by hand.
  - Native serialization is dangerous precisely because it transports type information; a data-only format leaves class selection with the application.

- Phase: Implementation
  - Strategy: Input Validation
  - Apply `allowlist` filtering so the deserializer can only instantiate an approved set of classes.
  - In Java use the JEP 290 `ObjectInputFilter` API, or set the `jdk.serialFilter` system property; in Jackson leave default typing disabled and register explicit subtypes; in Python avoid `pickle` entirely rather than subclassing `Unpickler`.
  - Use an allowlist, never a denylist: each newly discovered gadget-bearing library reopens a denylist, as CVE-2019-12384 showed.

- Phase: Architecture and Design
  - Strategy: Cryptography
  - `HMAC-sign` any serialized blob that must cross a trust boundary, and verify the tag before the bytes reach the parser.
  - Keep the signing key server-side and include a timestamp or nonce, otherwise a captured blob can still be replayed.
  - Encryption alone is insufficient; integrity is the property required.

- Phase: Architecture and Design
  - Strategy: Sandbox or Jail
  - Run deserialization in a low-privilege process with a minimal classpath, restricted filesystem access, and no outbound network.
  - Effectiveness: Defense in Depth
  - **Note:** This limits the blast radius of a successful gadget chain but does not prevent the deserialization itself.

- Phase: Operation
  - Keep gadget-bearing libraries patched, such as `commons-collections`, `XStream`, `jackson-databind`, and `Spring`.
  - The vulnerable sink is frequently reached through a transitive dependency, so the fix often lands outside first-party code.


Detection Methods

- Automated Static Analysis
  - Search for the known sinks, then trace whether external input can reach them.
    * Java: `ObjectInputStream.readObject`, `XMLDecoder.readObject`
    * PHP: `unserialize`
    * Python: `pickle.loads`, `yaml.load`
    * Ruby: `Marshal.load`
    * .NET: `BinaryFormatter.Deserialize`, `NetDataContractSerializer`
    * JavaScript: `node-serialize.unserialize`
  - Effectiveness: Moderate
  - **Note:** Locating the sink is straightforward, but proving that a working gadget chain is reachable requires the full dependency graph.

- Black Box
  - Inspect request bodies, cookies, headers, and hidden fields for serialization format markers.
    * Java: `AC ED 00 05`, or `rO0` once base64-encoded
    * .NET BinaryFormatter: `AAEAAAD/////`, base64 `AAEAAAD`
    * PHP: `O:` followed by a class-name length
    * Python pickle: protocol header bytes `80 04`
  - Effectiveness: Moderate

- Dependency Scanning
  - Use software composition analysis to inventory libraries known to carry gadget chains.
  - Exploitability depends on which gadgets are present on the classpath rather than on the application code, so a clean first-party scan is not evidence of safety.


> See the dedicated insecure deserialization note at `_posts/10CyberAttack/0ApplicationServerAttacks/2026-08-11-CyberAttack-Insecure-Deserialization.md` for gadget chain construction, per-language sinks, tooling, and detection engineering.
