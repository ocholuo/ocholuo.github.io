...
The code is careful to avoid a SQL injection attack ([CWE-89](/data/definitions/89.html)) but does not stop valid HTML from being stored in the database. This can be exploited later when ListUsers.php retrieves the information:
...
- [CVE-2006-4308](http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2006-4308): Chain: incomplete denylist ([CWE-184](/data/definitions/184.html)) only checks "javascript:" tag, allowing XSS ([CWE-79](/data/definitions/79.html)) using other tags
- [CVE-2007-5727](http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2007-5727): Chain: incomplete denylist ([CWE-184](/data/definitions/184.html)) only removes SCRIPT tags, enabling XSS ([CWE-79](/data/definitions/79.html))
...
- [CVE-2006-3295](http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2006-3295): Chain: library file is not protected against a direct request ([CWE-425](/data/definitions/425.html)), leading to reflected XSS ([CWE-79](/data/definitions/79.html)).
...
- Phases: Operation; Implementation
  - Strategy: Environment Hardening
  - When using PHP, configure the application so that it does not use register_globals. During implementation, develop the application so that it does not rely on this feature, but be wary of implementing a register_globals emulation that is subject to weaknesses such as [CWE-95](/data/definitions/95.html), [CWE-621](/data/definitions/621.html), and similar issues.
