...
[windows_support]: https://docs.ansible.com/ansible/latest/user_guide/windows.html
...
[ansible_official_installation]: https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html
...
[ansible_docs_python3_support]: https://docs.ansible.com/ansible/latest/reference_appendices/python_3_support.html
...
▲ `hostfile` 參數即將在 Ansible 2.8.0 被移除，若您是使 Ansible 2.4.0 以上的版本，請改用 `inventory`，詳情請參考[官方文件](https://docs.ansible.com/ansible/latest/installation_guide/intro_configuration.html#hostfile)。
