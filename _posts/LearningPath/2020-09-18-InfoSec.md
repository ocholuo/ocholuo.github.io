...
---|---
`MITM` | Burp Suite <br>![BurpSuite](https://i.imgur.com/IJkeA2y.png) <br> - web vulnerability scanner
---|---
...
Lab | Note
---|---
[Internet Security](http://site.iugaza.edu.ps/mammar/internet-security/) <br> -
[Attacklab](http://site.iugaza.edu.ps/nour/fall-2012/security-disc/) |
