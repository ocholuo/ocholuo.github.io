...
then the python interpreter will look for a file called `morecode.py`, execute its code, and make its object bindings available for reference in the rest of the code in `myprog.py`.
